...
def eval_for_metric(model, eval_loader, criterion=None, criterion_s3im=None, tta=False, input_size=512):
    avg_loss = 0
...
if __name__ == "__main__":
    ...
    parser.add_argument("--ckp-paths", type=str,default=["./runs/train/21/best_ckp/",])  
                                
    parser.add_argument("--cuda", type=str, default="0")

    parser.add_argument("--dataset-dir", type=str, default="/mnt/disk3/houyingying/dataset/CL-CD/")  
