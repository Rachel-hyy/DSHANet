...
class AFPN(nn.Module):
    def __init__(self, inplanes,
        ...
        self.conv00 = BasicConv(inplanes // 8, out_channels, 1)
        self.conv11 = BasicConv(inplanes*2 // 8, out_channels, 1)
        self.conv22 = BasicConv(inplanes*4 // 8, out_channels, 1)
        self.conv33 = BasicConv(inplanes*8 // 8, out_channels, 1)
